...
description_en: |
  The proposal takes the tetrapod breakwater block as its architectural prototype. Originally designed to dissipate wave energy, the tetrapod is transformed from coastal infrastructure into architectural language.
